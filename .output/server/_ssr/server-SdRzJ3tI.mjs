...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BQPJ-qKE.mjs");
...
const manifest = {
  "11d0f3e1b3fba4848212f85fb0c2d9530a93b4aa78618c1dc5f1c6843cbb252d": {
    functionName: "generateAiSummary_createServerFn_handler",
    importer: () => import("./ai-summary.functions-CMudH-sV.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CsPbxP-R.mjs").then((n) => n.r),
